...
> **⚠️ 实验性项目警告**: 此项目目前仅作为试验性项目维护，主要功能开发已集中在 [PixelTerm-C](https://github.com/zouyonghe/PixelTerm-C) 项目中，这是当前主要的开发重点。建议用户优先使用 C 语言版本以获得更好的性能和稳定性 - 作为原生 C 实现，它提供显著更快的图片处理速度和更低的内存占用。
